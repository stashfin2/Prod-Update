...
const processJob = async () => {
  try {
    ...
    const dataStream = conn
      .query("select * from installment_fip_cl where is_delete = 0 and customer_facing = 1 and inst_status = 1 and emi_status_id in (1,3) and inst_date < date(now()) limit 1000", [])
      .stream();
